...
docker run -it -e AWS_DEFAULT_REGION=$AWS_DEFAULT_REGION  -e AWS_ACCESS_KEY_ID=$AWS_ACCESS_KEY_ID -e AWS_SECRET_ACCESS_KEY=$AWS_SECRET_ACCESS_KEY -v $(pwd)/terraform:/terraform radar/terraform-builder:latest init
